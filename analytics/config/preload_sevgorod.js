define("__preload", function() {    
    var config = {
        ...
        tracker_id: ["UA-37849584-1","UA-38092225-1","UA-70020243-1"],
        yam_id: "19547275",
        ga_object: "ga",
    ...
    config.requirejs = {        
        paths: {
            ...
            "widgetPlanoplan" : "//widget.planoplan.com/js/widget.js" + "?callback=callBackFunction" // + Math.floor((Math.random() * 10000) + 1) + "=" + new Date().getTime()
        },
        waitSeconds: 0
    };
...
require(["__preload"], function(config) {
    ...
    require(["__postload", "libs", "analytics"], function(cfg) {
        ...
        for (var i=0;i<ntr;i++){ 
            ...
            if (i==0) {
                window.ga(cfg.tracker_name[0] + ".require", "GA_data", cfg);
